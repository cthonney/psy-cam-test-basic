...
class ConsultationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultation" do
    assert_difference("Consultation.count") do
      post consultations_url, params: { consultation: { psy: @consultation.psy, specialties: @consultation.specialties } }
    end
  ...
  test "should update consultation" do
    patch consultation_url(@consultation), params: { consultation: { psy: @consultation.psy, specialties: @consultation.specialties } }
